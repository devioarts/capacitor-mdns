var capacitormDNS = (function (exports, core) {
    'use strict';

    const mDNS = core.registerPlugin('mDNS', {
        web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.mDNSWeb()),
     ...
     */
    class mDNSWeb extends core.WebPlugin {
        constructor() {
            super(...arguments);
